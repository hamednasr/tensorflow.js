...
// Images are sotred in 784x70000x256 png image
// 784 is flatten image of dimension 28x28px
// 70000 is number of image samples
...
// size is 700.000 bytes that is 10 bits for 70000 images.
const MNIST_LABELS_PATH =
  "https://storage.googleapis.com/learnjs-data/model-builder/fashion_mnist_labels_uint8";

/**
 * A class that fetches the sprited fashion MNIST dataset and returns shuffled batches.
 *
...
export class FashionMnistData {
  ...
  async load() {
    // Make a request for the FashionMNIST sprited image.
